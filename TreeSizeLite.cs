// TreeSize Lite — a single-file WinForms disk usage browser.
// Compile: csc /target:winexe /out:TreeSizeLite.exe /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:Microsoft.VisualBasic.dll TreeSizeLite.cs
...
namespace TreeSizeLite
{
    ...
    public class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            Text = Program.IsAdmin ? "TreeSize Lite — Administrator" : "TreeSize Lite — limited (no admin)";
        ...
        void BuildUi()
        {
            ...
            ToolStripMenuItem miAbout = new ToolStripMenuItem("&About TreeSize Lite...");
        ...
        void scanBtn_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(t))
            {
                MessageBox.Show(this, "Click a drive on the left, or enter a path in 'Custom path' and press Scan.",
                    "TreeSize Lite", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            StartScan(t);
        }
        ...
        void StartScan(string targetRaw)
        {
            ...
            if (!Directory.Exists(target))
            {
                MessageBox.Show(this, "Path does not exist or is not accessible:\n" + target,
                    "TreeSize Lite", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        void PopulateList(FolderNode f)
        {
            ...
            list.EndUpdate();
            Text = "TreeSize Lite — " + f.FullPath + "  (" + Sizes.Format(f.Size) + ")";
        }
    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                string dir = Path.GetDirectoryName(typeof(Program).Assembly.Location);
                LogPath = Path.Combine(dir, "TreeSizeLite.log");
            }
            catch { LogPath = Path.Combine(Path.GetTempPath(), "TreeSizeLite.log"); }
            ...
            {
                string msg =
                    "TreeSize Lite is not running as Administrator.\n\n" +
                ...
                DialogResult dr = MessageBox.Show(msg, "TreeSize Lite — Elevation recommended",
            ...
            Application.ThreadException += new System.Threading.ThreadExceptionEventHandler(delegate(object s, System.Threading.ThreadExceptionEventArgs e)
            {
                ...
                try { MessageBox.Show("Error: " + e.Exception.Message + "\n\nLog: " + LogPath, "TreeSize Lite", MessageBoxButtons.OK, MessageBoxIcon.Error); }
                catch { }
            });
